...
export function passwordResetEmail(opts: { to: string; link: string; expiryHours: number }) {
	const html = `
<!DOCTYPE html>
<html lang="vi">
<head>
...
<body style="margin:0;padding:0;background:#FAFAF8;font-family:'Inter',Arial,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#FAFAF8;padding:40px 16px;">
        ...
        <table width="100%" style="max-width:480px;background:#fff;border-radius:16px;border:1px solid #E8E8E8;overflow:hidden;">
          ...
          <tr>
            <td style="padding:36px 32px;">
              ...
              <p style="margin:0 0 24px;color:#6B6B6B;font-size:15px;line-height:1.6;">
                Chúng tôi nhận được yêu cầu đặt lại mật khẩu cho tài khoản VASpeak của bạn.<br/>
                Nhấp vào nút bên dưới để tạo mật khẩu mới. Link này có hiệu lực trong <strong>${opts.expiryHours} giờ</strong> và chỉ dùng được một lần.
              </p>
              ...
              <p style="margin:0;color:#A3A3A3;font-size:12px;line-height:1.5;border-top:1px solid #E8E8E8;padding-top:16px;">
          ...
          <tr>
            <td style="background:#FAFAF8;padding:20px 32px;border-top:1px solid #E8E8E8;">
              <p style="margin:0;font-size:11px;color:#A3A3A3;text-align:center;">
                Email này được gửi tới <strong>${opts.to}</strong> theo yêu cầu đặt lại mật khẩu.
              </p>
            </td>
          </tr>
	...
	return {
		to:      opts.to,
		subject: '🔐 Đặt lại mật khẩu VASpeak của bạn',
		html
	};
}
